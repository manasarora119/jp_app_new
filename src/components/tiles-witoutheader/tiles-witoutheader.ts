...
/**
 * Generated class for the TilesWitoutheaderComponent component.
 *
 * See https://angular.io/docs/ts/latest/api/core/index/ComponentMetadata-class.html
 * for more info on Angular Components.
 */
@Component({
  selector: 'tiles-witoutheader',
  templateUrl: 'tiles-witoutheader.html'
})
export class TilesWitoutheaderComponent {
  ...
  ngOnInit() {
    ...
    //console.log(this.tilesItems);
  }

  goToAction(item, typeifo, myfilter = null, name = '') {

    this.myfilters = '';
    let addtocart = "Slider Name=tiles-witoutheader&From=Homg Page&type=" + typeifo + "&typeId=" + item;
    if (myfilter) {
