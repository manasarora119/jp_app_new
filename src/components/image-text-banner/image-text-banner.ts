...
@Component({
  selector: 'image-text-banner',
  templateUrl: 'image-text-banner.html'
})
export class ImageTextBannerComponent {

 @Input('textmg') message;
  public catogeryItems :any;
    myfilters:any;

  constructor(public alertCtrl: AlertController,
    public constants:ConstantsProvider,
    public navCtrl: NavController) {
    //console.log('Hello ImageTextBannerComponent Component');
  }

  ngOnInit(){
    //console.log(this.message);
     this.catogeryItems=this.message;
  }
